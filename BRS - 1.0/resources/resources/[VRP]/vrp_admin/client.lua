...
RegisterNetEvent('NZK:showBlips')
AddEventHandler('NZK:showBlips', function()
...
AddEventHandler("vehtuning",function(vehicle)
	...
	if IsEntityAVehicle(vehicle) then
		...
		SetVehicleNumberPlateText(vehicle,"BRS")
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(5000)
		if prisioneiro then
			local distance = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),1641.54,2570.48,45.56,true)
			if distance >= 25 then
				SetEntityCoords(PlayerPedId(),1641.54,2570.48,45.56)
