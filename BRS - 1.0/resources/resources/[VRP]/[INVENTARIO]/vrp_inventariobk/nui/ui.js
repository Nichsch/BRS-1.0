...
$(document).ready(function() {
  ...
  document.onkeyup = function(data) {
    if (data.which == 27) {
      $.post("http://vrp_inventario/invClose", JSON.stringify({}), function(datab) {});
    }
  };
});
...
var updateMochila = () => {
  ...
  $.post("http://vrp_inventario/requestMochila", JSON.stringify({}), data => {
