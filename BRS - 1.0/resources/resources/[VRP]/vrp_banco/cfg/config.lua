...
Config.SafeMinimum = 200000				-- Minimo que dá ao furar um caixa
Config.SafeMax = 300000					-- Maximo que dá ao furar um caixa

Config.Solda = "solda" 					-- Item solda
Config.Furadeira = "furadeira" 			-- Item furadeira
Config.DinheiroSujo = "dirty_money" 	-- Item de dinheiro sujo
Config.Cops = 0 						-- Quantidade minima de PMS
Config.PermCops = "perm.roubo" 	-- Permissao para os policiais
