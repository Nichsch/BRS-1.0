...
function vRP.generateRegistrationNumber()
	...
	local registration = ""
	repeat
		registration = vRP.generateStringNumber("DDLLLDD")
...
function vRP.generatePhoneNumber()
	...
	repeat
		phone = vRP.generateStringNumber("11-9DDDD")
...
AddEventHandler("vRP:playerSpawn",function(user_id, source, first_spawn)
	...
	if identity then
		vRPclient._setRegistrationNumber(source,identity.registration or "DDLLLDD")
	end
end)