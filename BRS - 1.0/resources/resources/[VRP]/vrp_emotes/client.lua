...
local animacoes = {
	...
	{ nome = "microfone" , dict = "amb@world_human_aa_coffee@base" , anim = "base" , prop = "prop_microphone_02" , flag = 50 , mao = 28422 },
	{ nome = "pipoca" , dict = "amb@world_human_aa_coffee@base" , anim = "base" , prop = "prop_trinket_cup_01 " , flag = 50 , mao = 28422 },
	{ nome = "dildo" , dict = "amb@world_human_aa_coffee@base" , anim = "base" , prop = "prop_cs_dildo_01" , flag = 50 , mao = 28422 },
	...
	{ nome = "maodada" , dict = "timetable@trevor@ig_1" , anim = "ig_1_therearejustsomemoments_patricia" , andar = true , loop = true },
	...
	{ nome = "champs" , dict = "anim@mp_player_intupperspray_champagne" , anim = "idle_a" , prop = "ba_prop_battle_champ_open" , flag = 49 , mao = 28422 },
	{ nome = "chuvad" , dict = "anim@mp_player_intupperraining_cash" , anim = "idle_a" , prop = "prop_anim_cash_pile_01" , flag = 50 , mao = 28422 },
	...
	{ nome = "ler" , dict = "cellphone@" , anim = "cellphone_text_read_base" , prop = "prop_novel_01" , flag = 50 , mao = 28422 },
	...
	{ nome = "comer4" , dict = "mp_player_inteat@burger" , anim = "mp_player_int_eat_burger" , prop = "prop_choc_ego" , flag = 49 , mao = 60309 },
	{ nome = "beber" , dict = "amb@world_human_drinking@beer@male@idle_a" , anim = "idle_a" , prop = "p_cs_bottle_01" , flag = 49 , mao = 28422 },
	{ nome = "rosa" , dict = "anim@heists@humane_labs@finale@keycards" , anim = "ped_a_enter_loop" , prop = "prop_single_rose" , flag = 49 , mao = 60309 },
	{ nome = "furioso", dict = "amb@world_human_drinking@beer@male@idle_a" , anim = "idle_a" , prop = "v_res_tt_can01" , flag = 49 , mao = 28422 },
	...
	{ nome = "vinho" , dict = "anim@heists@humane_labs@finale@keycards" , anim = "ped_a_enter_loop" , prop = "prop_drink_redwine" , flag = 49 , mao = 60309 },
	{ nome = "anotar" , dict = "amb@medic@standing@timeofdeath@base" , anim = "base" , prop = "prop_notepad_01" , flag = 49 , mao = 60309 },
	{ nome = "buque" , dict = "impexp_int-0" , anim = "mp_m_waremech_01_dual-0" , prop = "prop_snow_flower_02" , flag = 49 , mao = 60309 },
	{ nome = "ursinho" , dict = "impexp_int-0" , anim = "mp_m_waremech_01_dual-0" , prop = "v_ilev_mr_rasberryclean" , flag = 49 , mao = 60309 },
	...
	{ nome = "encostar2" , dict = "timetable@mime@01_gc" , anim = "idle_a" , andar = false , loop = true },
	{ nome = "arrastar" , dict = "move_injured_ground" , anim = "front_loop" , andar = false , loop = true },
	{ nome = "dedo" , dict = "anim@arena@celeb@podium@no_prop@" , anim = "flip_off_a_1st" , andar = false , loop = false },
	...
	{ nome = "uncuff", dict = "mp_arresting", anim = "a_uncuff", andar = false, loop = true },
	{ nome = "dancar" , dict = "rcmnigel1bnmt_1b" , anim = "dance_loop_tyler" , andar = false , loop = true },
	...
	{ nome = "horse" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@", anim = "dancecrowd_li_15_handup_laz" , andar = false , loop = true,  prop = "ba_prop_battle_hobby_horse" , flag = 50 , mao = 28422 },
	...
	{ nome = "sentar4" , dict = "amb@world_human_stupor@male@base" , anim = "base" , andar = false , loop = true },
	{ nome = "sentar5" , dict = "amb@world_human_picnic@female@base" , anim = "base" , andar = false , loop = true },
	{ nome = "sentar7" , dict = "timetable@reunited@ig_10" , anim = "base_amanda" , andar = false , loop = true },
	{ nome = "sentar8" , dict = "timetable@ron@ig_3_couch" , anim = "base" , andar = false , loop = true },
	{ nome = "sentar9" , dict = "anim@amb@business@bgen@bgen_no_work@" , anim = "sit_phone_phoneputdown_sleeping-noworkfemale" , andar = false , loop = true },
	{ nome = "sentar6" , dict = "anim@amb@nightclub@lazlow@lo_alone@" , anim = "lowalone_base_laz" , andar = false , loop = true },
	...
	{ nome = "assobiar" , dict = "rcmnigel1c" , anim = "hailing_whistle_waive_a" , andar = true , loop = false },
	{ nome = "joia" , dict = "anim@mp_player_intupperthumbs_up" , anim = "idle_a" , andar = true , loop = false },
	{ nome = "cruzarbraco" , dict = "amb@world_human_hang_out_street@female_arms_crossed@idle_a" , anim = "idle_a" , andar = true , loop = false },
	{ nome = "cruzarbraco2" , dict = "mini@strip_club@idles@bouncer@base" , anim = "base" , andar = true , loop = true },
	{ nome = "dedo" , dict = "anim@mp_player_intselfiethe_bird" , anim = "idle_a" , andar = true , loop = false },
	{ nome = "chamar" , dict = "friends@frl@ig_1" , anim = "waive_b_lamar" , andar = true , loop = false },
	{ nome = "cruzar" , dict = "amb@world_human_cop_idles@female@idle_b" , anim = "idle_e" , andar = true , loop = true },
	...
	{ nome = "bong" , dict = "anim@safehouse@bong" , anim = "bong_stage3" , prop = "hei_heist_sh_bong_01" , flag = 49 , mao = 60309 , extra = function() 
...
-----------------------------------------------------------------------------------------------------------------------------------------
local andarEstilos = { 
	{ ['command'] = "veio", ['anim'] = "move_lester_caneup"},
...
RegisterCommand("a",function(source,args)
	local comando = ""
	local arrayLenght = tablelength(andarEstilos)

	for k,v in pairs(andarEstilos) do
		if args[1] == v.command then
			vRP.loadAnimSet(v.anim)
		end
		-- print("arraylenght: "..arrayLenght.. " | k: " ..k)
		if arrayLenght ~= k then
			comando = comando.. " ^2/a ^5"..v.command.. "^2 | " 
		else
			comando = comando.. " ^2/a ^5"..v.command.. "^2."
		end
	end
	...
	if args[1] == "lista" then
		TriggerEvent('chatMessage',"LISTA DE ANIMAÇÃO: ",{255,70,50}, comando)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- FACIAL
-----------------------------------------------------------------------------------------------------------------------------------------
local facialEstilos = { 
	{ ['command'] = "bravo", ['anim'] = "mood_angry_1"},
	{ ['command'] = "bravo2", ['anim'] = "pose_angry_1"},
	{ ['command'] = "bebado", ['anim'] = "mood_drunk_1"},
	{ ['command'] = "ferido", ['anim'] = "pose_injured_1"},
	{ ['command'] = "eletrocutado", ['anim'] = "electrocuted_1"},
	{ ['command'] = "esforco", ['anim'] = "effort_1"},
	{ ['command'] = "drive", ['anim'] = "mood_drivefast_1"},
	{ ['command'] = "feliz", ['anim'] = "mood_happy_1"},
	{ ['command'] = "ferido2", ['anim'] = "mood_injured_1"},
	{ ['command'] = "dance", ['anim'] = "mood_dancing_low_1"},
	{ ['command'] = "fumar", ['anim'] = "smoking_hold_1"},
	{ ['command'] = "normal", ['anim'] = "pose_normal_1"},
	{ ['command'] = "visando", ['anim'] = "pose_aiming_1"},
	{ ['command'] = "chocado", ['anim'] = "shocked_1"},
	{ ['command'] = "chocado2", ['anim'] = "shocked_2"},
	{ ['command'] = "sono", ['anim'] = "mood_sleeping_1"},
	{ ['command'] = "morto", ['anim'] = "dead_1"},
	{ ['command'] = "morto2", ['anim'] = "dead_2"},
	{ ['command'] = "presuncoso", ['anim'] = "mood_smug_1"},
	{ ['command'] = "visando2", ['anim'] = "mood_aiming_1"},
	{ ['command'] = "estressado", ['anim'] = "mood_stressed_1"},
	{ ['command'] = "emburrado", ['anim'] = "mood_sulk_1"},
	{ ['command'] = "esforco2", ['anim'] = "effort_2"},
	{ ['command'] = "esforco3", ['anim'] = "effort_3"},
}

RegisterCommand("f",function(source,args)
	local comando = ""
	local arrayLenght = tablelength(facialEstilos)

	for k,v in pairs(facialEstilos) do
		if args[1] == v.command then
			SetFacialIdleAnimOverride(PlayerPedId(), v.anim, 0)
		end
		if arrayLenght ~= k then
			comando = comando.. " ^2/f ^5"..v.command.. "^2 | " 
		else
			comando = comando.. " ^2/f ^5"..v.command.. "^2."
		end
	end
...
-- EMOTES EM DUPLAS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('NZK:EmotesDupla')
AddEventHandler('NZK:EmotesDupla',function(sync)
		...
		if sync == 1.0 then
			coords = GetOffsetFromEntityInWorldCoords(pedInFront, 0.0, 1.0, 0.0)
		else
			coords = GetOffsetFromEntityInWorldCoords(pedInFront, 0.0, sync, 0.0)
		end
...
local ragdoll = false
RegisterNetEvent('NZK:ragDoll')
AddEventHandler('NZK:ragDoll',function(time)
