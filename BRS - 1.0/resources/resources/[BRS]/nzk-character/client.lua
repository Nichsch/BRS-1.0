...
RegisterNetEvent("nzk-character:normalSpawn")
RegisterNetEvent("nzk-character:characterCreate")
...
AddEventHandler("nzk-character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("nzk-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
        ...
        SetPedComponentVariation(PlayerPedId(),3,15,0,2)
        SetPedComponentVariation(PlayerPedId(),4,62,1,2)
        SetPedComponentVariation(PlayerPedId(),8,15,0,2)
        SetPedComponentVariation(PlayerPedId(),6,5,0,2)
        SetPedComponentVariation(PlayerPedId(),11,5,0,2)
        ...
        SetPedPropIndex(PlayerPedId(),2,-1,0,2)
        SetPedPropIndex(PlayerPedId(),6,5,0,2)
        SetPedPropIndex(PlayerPedId(),7,15,0,2)
	else
        SetPedComponentVariation(PlayerPedId(),1,0,0,2)
        SetPedComponentVariation(PlayerPedId(),5,0,0,2)
        SetPedComponentVariation(PlayerPedId(),7,0,0,2)
        SetPedComponentVariation(PlayerPedId(),9,0,2)
        SetPedComponentVariation(PlayerPedId(),4,23,12,2)
        SetPedComponentVariation(PlayerPedId(),8,34,0,2)
        SetPedComponentVariation(PlayerPedId(),6,8,0,2)
        SetPedComponentVariation(PlayerPedId(),11,75,0,2)
        ...
        SetPedPropIndex(PlayerPedId(),1,-1,0)
        SetPedPropIndex(PlayerPedId(),2,-1,0)
        SetPedPropIndex(PlayerPedId(),6,-1,0)
        SetPedPropIndex(PlayerPedId(),7,-1,0)
	end

	SetEntityCoordsNoOffset(PlayerPedId(),-1038.16,-2738.70,13.81,true,true,true)
	SetEntityHeading(PlayerPedId(),f(158.62))
	vRP.CarregarObjeto("","","prop_ld_suitcase_01",50,57005,0.40,0,0,0)
	...
	print("Nome: "..characterNome.. " Sobrenome:" ..characterSobrenome.. "Idade: "..characterAge)
	TriggerServerEvent("nzk-character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
